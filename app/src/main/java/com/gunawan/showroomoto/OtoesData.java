...
public class OtoesData {
    private static String[] otoNames = {
            "Alphard",
            "Avanza",
            "Honda_Civic",
            "Ford_Ranger",
    ...
    private static String[] otoDetails = {
    ...
    private static int[] otoesImages = {
            R.drawable.alphard,
            R.drawable.avanza,
            R.drawable.civic,
            R.drawable.ford_ranger,
            R.drawable.fortuner,
            R.drawable.hrv,
            R.drawable.jazz,
            R.drawable.juke,
    ...
    static ArrayList<Oto> getListData() {
        ArrayList<Oto> list = new ArrayList<>();
        for (int position = 0; position < otoNames.length; position++) {
            Oto oto = new Oto();
            oto.setName(otoNames[position]);
            oto.setDetail(otoDetails[position]);
            oto.setPhoto(otoesImages[position]);
            list.add(oto);
        }
        return list;
    }
